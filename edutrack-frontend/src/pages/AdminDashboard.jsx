...
const AdminDashboard = ({ user, onSwitchToStudent, onLogout }) => {
  ...
  const handleDeleteExam = async (id) => {
    if (window.confirm('Are you sure you want to delete this assignment?')) {
      try {
        await axios.delete(`https://edutrack-backend-rtoh.onrender.com/api/exams/delete/${id}`);
  ...
  const handlePublishAssignment = async (e) => {
    ...
    try {
      await axios.post('https://edutrack-backend-rtoh.onrender.com/api/exams/create', payload);
